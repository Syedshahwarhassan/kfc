    ...
    <div style={{ backgroundColor: "black", height: "100%" }}>
            ...
            {top.map((c) => {
              return (
                ...
                >
                  ...
                  />
                  <h6 id="besth6">{c.title.slice(0, 15)}</h6>
                  <h6 id="des">{c.des.slice(0, 30)}...</h6>
                  <h5
                    id="besth5"
                    style={{
      ...
      <div id="squarimage">
        ...
        <div id="squar1">
          ...
          />
          <div id="roundedimage">
            <img src="https://www.kfcpakistan.com/static/media/kfc-meal.afc417f5d19998efd26b.png" />
            <h6 style={{color:"white",textAlign:"center"}}>Adding 11 herbs and spices, Explore our menu and add items to your cart.</h6>
      ...
      <div className="top-footer">
        ...
        <div className="footer-icon">
          ...
          <i className="fa-brands fa-instagram" style={{ color: "hotpink" }} />
          <i className="fa-brands fa-facebook" style={{ color: "blue" }} />
        </div>
      </div>
      <footer>
        <div id="footerdiv">
          <h5 id="footertext">About Us</h5>
          <h5 id="footertext">Maitho Bhook</h5>
          <h5 id="footertext">Maitho Bhook-Scholarship</h5>
          <h5 id="footertext">Privacy Policy</h5>
          <h5 id="footertext">Career</h5>
        </div>
        <div id="footerdiv">
        <h5 id="footertext">Contact us</h5>
          <h5 id="footertext">Store Locator</h5>
          <h5 id="footertext">Track Order</h5>
        </div>
        <div id="footerdiv">
        <h5 id="footertext">Term & condition</h5>
        </div>
        <div id="footerdiv">
      ...
      <div id="endfooter"><h6>2023 KFC. All rights reserved</h6></div>
      <div id="endfooter"><h5 style={{color:"#E4002b",fontWeight:"bolder"}}>Powered By</h5><h6 style={{textDecoration:"underline"}}>Syed Shahwar Hassan</h6></div>
      </div>
    </div>
  );
};
